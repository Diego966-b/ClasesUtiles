...
<?php
    for ($i = 1; $i <= 2; $i++) {
        ...
        echo 
        '<p class="mt-1 mx-4"><a class="link-light link-offset-2 link-underline-opacity-0 link-underline-opacity-100-hover '.$seleccionado.'" href="'.$VISTA.'/'.$colPaginas[$i].'.php">'.$colPaginas[$i].'</a></p>';
    }
?>
    </div>   
</div>